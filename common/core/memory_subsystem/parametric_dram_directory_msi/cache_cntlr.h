...
//---PRAK-LOG ADDING NEW FUNCTION-------------------------------------------------------------------------------         
	bool operationPermissibleinCache(
               IntPtr address, Core::mem_op_t mem_op_type, CacheBlockInfo **cache_block_info = NULL);

bool operationPermissibleinFlexCache(IntPtr address, Core::mem_op_t mem_op_type,bool isShared,bool isFlexOp, CacheBlockInfo **cache_block_info = NULL);

SharedCacheBlockInfo*
 getFlexCacheBlockInfo(IntPtr address,bool isShared,bool isFlexOp);
